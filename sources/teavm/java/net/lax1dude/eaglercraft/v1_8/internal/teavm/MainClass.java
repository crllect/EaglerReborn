...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			systemOut.println("MainClass: [INFO] registering crash handlers");
			...
			try {
				...
				systemErr.println("MainClass: [ERROR] this browser is incompatible with eaglercraftx!");
				systemErr.println("MainClass: [ERROR] Reason: " + ex.getMessage());
				try {
